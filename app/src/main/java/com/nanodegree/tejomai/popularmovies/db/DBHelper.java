...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public boolean insertFavourite(String id, String url, String title, String releaseDate, String vote){
    ...
    public Cursor fetchFavorites(){
        ...
        String[] selection = { FAVORITES_TABLE_NAME_COLUMN_ID, FAVORITES_TABLE_NAME_COLUMN_URL, FAVORITES_TABLE_NAME_COLUMN_TITLE, FAVORITES_TABLE_NAME_COLUMN_RELEASE, FAVORITES_TABLE_NAME_COLUMN_VOTE };
